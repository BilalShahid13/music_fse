...
mixin _$Genre {
  ...
  @override
  String toString() {
    return 'Genre(name: $name, songCount: $songCount)';
  }
}
...
abstract mixin class $GenreCopyWith<$Res> {
  factory $GenreCopyWith(Genre value, $Res Function(Genre) _then) =
      _$GenreCopyWithImpl;
  @useResult
  $Res call({String name, int songCount});
}
...
extension GenrePatterns on Genre {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String name, int songCount)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Genre() when $default != null:
        return $default(_that.name, _that.songCount);
      case _:
        return orElse();
    }
  }
...
class _Genre implements Genre {
  const _Genre({required this.name, required this.songCount});
